...
from pymergetic.wasmmod.cdn.web.context import _url, resolve_brand_logo_url
...
async def _shell_context(
    ...
    *,
    ...
    if request is not None:
        ...
        try:
            from pymergetic.wasmmod.cdn.web.page_helpers import _merge_fed_catalog
