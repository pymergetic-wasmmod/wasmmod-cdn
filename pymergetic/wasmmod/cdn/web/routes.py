...
from pymergetic.wasmmod.cdn.api.deps import IndexServiceDep, OptionalUserDep, ShellSessionServiceDep
...
from pymergetic.wasmmod.cdn.services.shell_sessions import ensure_principal
from pymergetic.wasmmod.cdn.web.context import (
    _cdn_base_url,
    _url,
    configure_web,
...
async def repl_autoexec(
    ...
    script = render_autoexec(
        ...
        principal=principal,
        driver=shell.driver or "wasmmod-cdn",
        engine=engine,
    )
