...
from pymergetic.wasmmod.cdn.api import build_api_router
from pymergetic.wasmmod.cdn.db import Database
from pymergetic.wasmmod.cdn.middleware import (
    CsrfMiddleware,
    RateLimitMiddleware,
...
from pymergetic.wasmmod.cdn.services.naked_cache import (
    install_naked_cache,
    naked_cache_from_settings,
)
from pymergetic.wasmmod.cdn.settings import Settings, get_settings
from pymergetic.wasmmod.cdn.storage import build_storage
from pymergetic.wasmmod.cdn.web.routes import configure_web, web_router
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    from pymergetic.wasmmod.cdn.api.inspect_contract import mount_inspect_contract
