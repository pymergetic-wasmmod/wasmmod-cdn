...
from pymergetic.wasmmod.cdn.api.extended import register_package_extensions
...
async def list_packages(
    ...
    if channel == "lead":
        try:
            from pymergetic.wasmmod.cdn.services.federation.catalog import merge_catalog
