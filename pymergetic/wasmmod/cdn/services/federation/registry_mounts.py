...
from pymergetic.wasmmod.cdn.models import utcnow
from pymergetic.wasmmod.cdn.services.federation.prefix import (
    longest_prefix_mount,
)
from pymergetic.wasmmod.cdn.services.federation.secrets import (
    decrypt_secret,
    encrypt_secret,
    secret_fingerprint,
)
...
class MountOpsMixin:
    ...
    async def set_credential(
        ...
        *,
        ...
        if kind == FederationCredKind.FED_KEY:
            from pymergetic.wasmmod.cdn.services.federation.tickets import public_from_private
    ...
    async def install_fed_key(self, mount_id: UUID) -> FederationFedKeyCreated:
        ...
        from pymergetic.wasmmod.cdn.services.federation.tickets import generate_keypair
