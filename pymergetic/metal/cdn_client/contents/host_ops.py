...
def _embedded_text_sources(data: bytes) -> dict[str, str]:
    ...
    from pymergetic.metal.cdn_client.contents.extract import extract_embedded_file
    from pymergetic.metal.cdn_client.contents.inventory import inspect_artifact
