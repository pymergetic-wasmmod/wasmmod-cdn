...
from pymergetic.metal.cdn.api.artifacts import artifacts_router
from pymergetic.metal.cdn.api.auth import auth_router
...
from pymergetic.metal.cdn.api.federation import (
    federation_admin_router,
    federation_public_router,
)
from pymergetic.metal.cdn.api.health import health_router
from pymergetic.metal.cdn.api.identity_routes import acl_router, users_router
from pymergetic.metal.cdn.api.packages import packages_router
from pymergetic.metal.cdn.api.publish import publish_router
