"""pymergetic.metal.cdn — async FastAPI CDN for wasmmod packs."""
...
def resolve_version() -> str:
    try:
        from pymergetic.metal.cdn._version import version as scm_version

        return scm_version
    except ImportError:
        pass
    try:
        return version("pymergetic-metal-cdn")
...
def _git_describe_fallback() -> str:
    ...
    # pymergetic/metal/cdn/__init__.py → repo root
