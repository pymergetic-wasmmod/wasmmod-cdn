...
| `hex-pyc.png` | Hex dump of a `.pyc` inside the pack |

Refresh after UI changes: capture from `https://cdn.pymergetic.com/cdn/` (or local `./scripts/dev-up.sh`) and replace these files.
